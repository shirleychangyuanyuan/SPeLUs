...
class Model(ModelDesc):
    ...
    def _build_graph(self, inputs):
        ...
        def elu_network(x):
            ...
            conv1_stack1 = BatchNorm('stack1/bn1',conv1_stack1)
            ...
            conv1_stack2 = BatchNorm('stack2/bn1',conv1_stack2)
            ...
            conv2_stack2 = BatchNorm('stack2/bn2',conv2_stack2)
            ...
            conv1_stack3 = BatchNorm('stack3/bn1',conv1_stack3)
            ...
            conv2_stack3 = BatchNorm('stack3/bn2',conv2_stack3)
            ...
            conv1_stack4 = BatchNorm('stack4/bn1',conv1_stack4)
            ...
            conv2_stack4 = BatchNorm('stack4/bn2',conv2_stack4)
            ...
            conv1_stack5 = BatchNorm('stack5/bn1',conv1_stack5)
            ...
            conv2_stack5 = BatchNorm('stack5/bn2',conv2_stack5)
            ...
            conv1_stack6 = BatchNorm('stack6/bn1',conv1_stack6)
            ...
            conv1_stack7 = BatchNorm('stack7/bn1',conv1_stack7)
...
if __name__ == '__main__':
    ...
    parser.add_argument("-g", "--gpuid", type=str, help='GPU to use (leave blank for CPU only)', default="3")
